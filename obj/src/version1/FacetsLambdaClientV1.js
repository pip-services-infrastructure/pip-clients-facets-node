...
class FacetsLambdaClientV1 extends pip_services_aws_node_1.CommandableLambdaClient {
    constructor(config) {
        super('facets');
        if (config != null)
...
exports.FacetsLambdaClientV1 = FacetsLambdaClientV1;
//# sourceMappingURL=FacetsLambdaClientV1.js.map